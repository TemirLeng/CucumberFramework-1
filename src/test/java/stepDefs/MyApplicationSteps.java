...
public class MyApplicationSteps {
    ...
    @When("^User gets employee info for employee_id \"([^\"]*)\" data from UI$")
    public void user_gets_employee_info_for_employee_id_data_from_UI(String employee_id) throws Throwable {
